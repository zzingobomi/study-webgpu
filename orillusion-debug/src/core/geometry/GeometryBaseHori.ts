...
import { GeometryIndicesBufferHori } from "./GeometryIndicesBufferHori";
import { GeometryVertexBufferHori } from "./GeometryVertexBufferHori";
...
export class GeometryBaseHori {
  ...
  private _indicesBuffer: GeometryIndicesBufferHori;
  private _vertexBuffer: GeometryVertexBufferHori;
  ...
  constructor() {
    ...
    this._vertexBuffer = new GeometryVertexBufferHori();
  }

  public get indicesBuffer(): GeometryIndicesBufferHori {
    return this._indicesBuffer;
  }

  public get vertexBuffer(): GeometryVertexBufferHori {
  ...
  public setIndices(data: ArrayBufferData) {
    if (!this._attributeMap.has(VertexAttributeName.indices)) {
      ...
      this._indicesBuffer = new GeometryIndicesBufferHori();
      this._indicesBuffer.createIndicesBuffer();
    }
  }
  ...
  public computeNormals(): this {
    ...
    let point1 = GeometryBaseHori.point1;
    let point2 = GeometryBaseHori.point2;
    let point3 = GeometryBaseHori.point3;
    let crossA = GeometryBaseHori.crossA;
    let crossB = GeometryBaseHori.crossB;
    let crossRet = GeometryBaseHori.crossRet;
