...
import { VertexGPUBufferHori } from "../../gfx/graphics/webGpu/core/buffer/VertexGPUBufferHori";

export class GeometryVertexBufferHori {
  public vertexCount: number = 0;
  public vertexGPUBuffer: VertexGPUBufferHori;
  ...
  private createSplitVertexBuffer(
    ...
    this.vertexGPUBuffer = new VertexGPUBufferHori();
  }
