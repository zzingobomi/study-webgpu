...
class Sample_ChangeMaterial {
  ...
  async initScene() {
...

    {
      ...
      material.baseMap = await Engine3D.res.loadTexture(
        "https://cdn.orillusion.com/textures/diffuse.jpg"
      );
...

    {
      ...
      mat1.baseMap = await Engine3D.res.loadTexture(
        "https://cdn.orillusion.com/textures/cell.webp"
      );
      mat1.baseColor = new Color(0, 1, 0.5, 1.0);
      mat1.blendMode = BlendMode.ADD;
      mat1.transparent = true;
      let mat2 = new LitMaterial();
      mat2.baseMap = await Engine3D.res.loadTexture(
        "https://cdn.orillusion.com/textures/grid.webp"
      );
